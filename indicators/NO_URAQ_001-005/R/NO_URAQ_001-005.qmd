...
- <u>uncertainty of defining the target area</u>: the indicators presented in this document have been compiled in accordance with different interpretations of the urban areas, see more in Section 1.1. The instructions outlined in @handbook2026 do not align well with SEEA EA principles. All the URAQ indicators present a different definition of the EEA, which greatly impact sthe results and is thus an important source of uncertainty.
