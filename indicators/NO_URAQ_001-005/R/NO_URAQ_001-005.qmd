...
# Path to GK
gk_path <- "/data/P-Prosjekter2/412413_2023_no_egd/git_data/GK_processed/GK_final.gpkg"
...
ddbs_transform(x = "grunnkart_32",
               y = st_crs(pm25_data[[1]]),
               conn = conn_pm,
               name = "grunnkart_33",
               overwrite = TRUE)
...
# Re-project in the CRS of pm2.5 data
lau_dgurb <- st_transform(lau_dgurb, crs = crs(pm25_data[[1]]))
...
lau_et01 <- ddbs_intersection("grunnkart",
                              "lau",
                              conn = conn_pm,
                              conn_x = conn_pm,
                              conn_y = conn_pm,
